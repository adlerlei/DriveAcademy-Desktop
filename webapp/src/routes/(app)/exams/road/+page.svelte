<script lang="ts">
    ...
    function handlePrintRecord() {
        ...
        alert(
            `列印道考計分表：${printTimeSlot} ${printStartNumber}-${printEndNumber}號 功能開發中`,
        );
    }
</script>
...
<div class="space-y-6">
    ...
    <GlassCard>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="flex flex-col gap-1.5">
                ...
                >
                <select
                    class="h-10 w-full px-4 glass rounded-lg text-charcoal-800 border border-charcoal-800/10 focus:outline-none focus:ring-2 focus:ring-amber-400/50"
                    bind:value={examItem}
                >
    ...
    <GlassCard padding="none">
        <div class="p-4 border-b border-charcoal-800/10">
            <h2 class="text-lg font-semibold text-charcoal-800">道考清冊</h2>
