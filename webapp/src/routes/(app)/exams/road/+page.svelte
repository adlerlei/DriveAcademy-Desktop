<script lang="ts">
    ...
    function handlePrintRecord() {
        ...
        alert(
            `列印道考計分表：${printTimeSlot} ${printStartNumber}-${printEndNumber}號`,
        );
    }
</script>
    ...
    <GlassCard>
        ...
        <div class="flex flex-wrap items-end gap-4">
            <div class="flex flex-col gap-1.5 w-32">
                ...
                ><select
                    class="h-10 w-full px-3 glass-input rounded-md focus:outline-none"
                    bind:value={printTimeSlot}
                    ><option value="">-</option>{#each timeSlots as slot}<option
