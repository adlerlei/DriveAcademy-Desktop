    ...
    <GlassCard>
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-6 md:grid-cols-12 gap-3">
                ...
                <div
                    class="col-span-full sm:col-span-3 md:col-span-1 sm:col-span-2 md:col-span-2 flex flex-col gap-1.5"
                >
                    <label class="text-sm font-medium text-charcoal-700"
                        >梯次</label
                    >
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-6 md:grid-cols-12 gap-3">
                <div
                    class="col-span-full sm:col-span-3 md:col-span-1 sm:col-span-3 md:col-span-3 flex flex-col gap-1.5"
                >
                    <label class="text-sm font-medium text-charcoal-700"
                        >學員編號</label
                    >
                ...
                />
                <div
                    class="col-span-full sm:col-span-3 md:col-span-1 sm:col-span-1 md:col-span-1 flex flex-col gap-1.5"
                >
                    <label class="text-sm font-medium text-charcoal-700"
                        >郵遞區號</label
                    >
                ...
                />
                <div
                    class="col-span-full sm:col-span-3 md:col-span-1 sm:col-span-3 md:col-span-4 flex flex-col gap-1.5"
                >
                    <label class="text-sm font-medium text-charcoal-700"
                        >指導教練</label
                    >
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-6 md:grid-cols-12 gap-3">
                ...
                <GlassInput
                    ...
                    type="email"
                    bind:value={email}
                    class="col-span-full sm:col-span-3 md:col-span-6"
                />
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-6 md:grid-cols-12 gap-3">
                ...
                <div
                    class="col-span-full sm:col-span-3 md:col-span-1 sm:col-span-2 md:col-span-1 flex flex-col gap-1.5"
                >
                    <label class="text-sm font-medium text-charcoal-700"
                        >郵遞區號</label
                    >
                ...
                <GlassInput
                    label="詳細地址"
                    bind:value={rAddress}
                    class="col-span-full sm:col-span-3 md:col-span-1 sm:col-span-6 md:col-span-7"
                />
            </div>
        </div>
