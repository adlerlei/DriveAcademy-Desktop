    ...
    <GlassCard>
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-6 md:grid-cols-12 gap-3">
                ...
                <GlassInput label="期別" bind:value={term} class="col-span-1 sm:col-span-1 sm:col-span-3 md:col-span-3 md:col-span-1 sm:col-span-3 md:col-span-2" />
                <GlassInput label="年度" bind:value={year} class="col-span-1 sm:col-span-1 sm:col-span-3 md:col-span-3 md:col-span-1 sm:col-span-3 md:col-span-3" />
            </div>
        </div>
